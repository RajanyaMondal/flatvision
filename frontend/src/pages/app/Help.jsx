...
const Help = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-8 py-8">
      ...
      <Card>
        <h2 className="text-lg font-bold text-white mb-4">Understanding the ML Model</h2>
      ...
      <Card>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-medium text-white">How accurate is the prediction?</h3>
          ...
          <div>
            <h3 className="font-medium text-white">Why does the model need my location/facing?</h3>
          ...
          <div>
            <h3 className="font-medium text-white">Is my data private?</h3>

...
if (!clerkPubKey || !clerkPubKey.startsWith('pk_')) {
  ReactDOM.createRoot(document.getElementById('root')).render(
    <div style={{ padding: '40px', color: '#ffb3d9', background: '#2E1128', minHeight: '100vh', fontFamily: 'sans-serif', textAlign: 'center' }}>
      ...
      <p style={{ marginTop: '10px', color: '#7C6274' }}>It should start with <code>pk_test_</code> or <code>pk_live_</code>. Currently, it is set to a placeholder or is invalid.</p>
